...
public class ValidateCBARadioBtn extends BaseClass{
	
	@Test(groups="RegressionTest")
	public void ValidateCopyBillingAddressRadiobutton() throws EncryptedDocumentException, IOException, InterruptedException
	{
		...
		WebElement ele = createOrg.getCopyBillingAddressRadiobutton();
		
		boolean enabled= ele.isEnabled();
		if(enabled)
		{
			System.out.println("Copy billing address radio button is enabled");
		}else{
			System.out.println("Copy billing address radio button is not-enabled");
		}
