...
public class ValidateNOCkeckBox extends BaseClass{

@Test(groups="RegressionTest")
public void NotifyOwnerChechboxvalidation() throws EncryptedDocumentException, IOException, InterruptedException
{
	...
	WebElement ele = createOrg.getNotifyOwnerCkeckBox();
	
	boolean enabled= ele.isEnabled();
	if(enabled)
	{
		System.out.println("Notify owner checkbok is enabled");
	}else{
		System.out.println("Notify owner checkbok is not-enabled");
	}
